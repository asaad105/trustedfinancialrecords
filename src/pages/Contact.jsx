...
const openMailFallback = (inquiryData) => {
  const subject = encodeURIComponent(`New Contact Inquiry: ${inquiryData.full_name || 'Contact'}`);
...
export default function Contact() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      console.error('Inquiry submission failed, opening mail fallback', error);
